...
create table IF NOT EXISTS journal (id bigint generated by default as identity, date_time_created timestamp, description varchar(255), email varchar(255), entry varchar(255), image_path varchar(255), primary key (id))
